view: NumericDataSeries {
  ...
  dimension_group: eventTimestamp {
    description: "Timestamp of reading"
    type: time
    sql: ${TABLE}.eventTimestamp ;;
  }

  dimension: payloadQualifierJson {
  ...
  dimension: image_url {
    description: "GCS url of image file"
    type: string
    sql: CAST(JSON_EXTRACT(${TABLE}.payloadQualifierJson, '$[0].value') AS STRING) ;;
  }
